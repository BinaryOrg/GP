...
@interface FFFMyMovieViewController ()
<
UITableViewDelegate,
...
@implementation FFFMyMovieViewController

- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT - NavBarHeight - 45) style:UITableViewStyleGrouped];
...
- (void)sendRequest {
    ...
    [MFNETWROK post:@"http://120.78.124.36:10020/WP/Movie/GetMovieByUserId"
