//
//  LHScrollHeaderView.m
//  SwipeTableView
//
//  Created by Maker on 16/1/15.
//  Copyright © 2019年 Maker. All rights reserved.
//

#import "GPScrollHeaderView.h"
...
@interface GPScrollHeaderView ()<UIDynamicAnimatorDelegate>
...
static void * LHScrollHeaderViewPanGestureRecognizerStateContext = &LHScrollHeaderViewPanGestureRecognizerStateContext;

@implementation GPScrollHeaderView
...
- (void)commonInit {
    ...
    [self.panGestureRecognizer addObserver:self forKeyPath:@"state" options:NSKeyValueObservingOptionNew | NSKeyValueObservingOptionOld context:LHScrollHeaderViewPanGestureRecognizerStateContext];
    // animator
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context {
    if (context == LHScrollHeaderViewPanGestureRecognizerStateContext) {
